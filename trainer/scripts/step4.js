...
var step4 = function () {
    ...
    function getParams(name) {
        switch(name) {
            ...
            case "L_EXT":
                return ["SIDE_LENGTH", "FRONT_LENGTH", "SIDE_WIDTH", "FRONT_WIDTH", "HEIGHT"];
            case "GENGON":
                return ["RADIUS", "HEIGHT", "FILLET", "SIDES"];
            case "C_EXT":
                return ["BACK_LENGTH", "SIDE_LENGTH", "FRONT_LENGTH", "BACK_WIDTH", "SIDE_WIDTH", "FRONT_WIDTH", "HEIGHT"];
            case "PRISM":
    ...
    function updateImage(order, changeImageOrder) {
        if(changeImageOrder[0] == order[0]){
            let imgId = currentImageNumber >= 5 ? (++currentImageNumber + "-" + userVariant) : ++currentImageNumber;
