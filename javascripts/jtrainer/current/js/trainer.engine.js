...
$(document).ready(function () {
  ...
  var init = function () {
    ...
    if (langParam != "") I18N.setLanguage(langParam);
    else I18N.setLanguage(config["DEFAULT_LANG"]);

    $("#aboutBody")
      .html(Service.about())
      .append(
        "</br><strong>Current trainer author: </strong>" +
          (config["TRAINER_AUTHOR"] ? config["TRAINER_AUTHOR"] : "Unknown") +
          "</br><strong>Course author: </strong>" +
          (config["COURSE_AUTHOR"] ? config["COURSE_AUTHOR"] : "Unknown")
      );
...
function Logger() {
   ...
   */
  this.debug = function () {
    if (Logger.level === 0) consoleLog(arguments, _debug);
  };
   ...
   */
  this.info = function () {
    if (Logger.level <= 1) consoleLog(arguments, _info);
  };
  ...
  this.catching = function () {
    if (Logger.level <= 2) consoleLog(arguments, _catching);
  };
   ...
   */
  this.error = function () {
    if (Logger.level <= 2) consoleLog(arguments, _error);
  };
}
Logger.level = 0;
  ...
  Templatetor = function () {
    ...
    this.extendView = function (o) {
      if (typeof o !== "object")
        throw new IllegalArgumentException(
          "Mustache view should be extended with an object"
        );
      $.extend(view, o);
      return this;
    };
    ...
    this.setTemplate = function (o) {
      if (typeof o !== "string" && !(o instanceof jQuery))
        throw new IllegalArgumentException(
          "Template should be a string or jQuery object"
        );
      template = o;
      return this;
    };
    ...
    this.render = function () {
      if (!template) throw new IllegalStateException("Template is undefined");
      ...
      if (template instanceof $ && replaceMode === true) {
        ...
        var tpl;
        if (template instanceof $) tpl = template.html();
        else if (typeof template === "string") tpl = template;
        else throw new IllegalStateException("Unknown type of template");
...
var Scorer = new (function () {
  ...
  this.addScore = function (s) {
    ...
    else if (s > totalScore) throw new IllegalStateException("Illegal adding");
    score += s;
  ...
  this.getFormattedStartTime = function () {
    if (!startTime) throw new IllegalStateException("Start scorer first!");
    return (
      startTime.getHours() +
      ":" +
  ...
  this.getFormattedEndTime = function () {
    if (!startTime) throw new IllegalStateException("Finish scorer first!");
    return (
      endTime.getHours() +
      ":" +
      endTime.getMinutes() +
  ...
  this.getTimeDifference = function () {
    if (!endTime) throw new IllegalStateException("Finish scorer first!");
    return diffTime;
  };
...
(function ($, _Logger, _Templatetor) {
  ...
  I18N = new (function () {
    ...
    this.setAvailableLanguages = function (a) {
      if (typeof a !== "object")
        throw new IllegalArgumentException(
          "Langs should be an object (assoc array)"
        );
      for (var key in a) {
    ...
    this.setLanguage = function (l) {
      ...
      if (!langs.hasOwnProperty(l)) {
        LOGGER.info(
          "Language is not one of available languages. I'll set another, ok?"
        );
...
(function ($, _Scorer, _Logger) {
  ...
  Service = new (function () {
    ...
    this.setConfigPath = function (p) {
      if (typeof p === "string") CONFIG_FILE = p;
      return this;
    };
    ...
    this.notifyServer = function (callback) {
      ...
      $.get(server_info_url)
        .done(function (data) {
          server_url =
            "https://" + window.location.host + data.replace("server_url=", "");
          $.get(server_url)
            .done(function (data) {
              send_report_url =
                "https://" +
                window.location.host +
                data.replace("send_report_url=", "");
              $.get(send_report_url);
    ...
    this.pushResults = function (options, callback) {
      ...
      return Service.pushResultsPromise(options).then(
        callback,
    ...
    this.pushResultsPromise = function (options) {
      ...
      LOGGER.debug(
        "Sending user's result: " + JSON.stringify(userResult, null, 4)
      );
      return $.post(reportUrl, userResult).done(function (data) {
    ...
    this.pushResultsEarly = function (callback) {
      ...
      is_passed = 1;
      Rotator.nextResults();
      return Service.pushResultsPromise()
        .then(function () {
    ...
    var setConfigValues = function (data, holder) {
      ...
      if (!holder) holder = Service.getTrainerConfig();
      data = data.split("&");
      var arrayLength = data.length;
      for (var i = 0; i < arrayLength; i++) {
        var key_and_value = data[i].split("=");
        holder[key_and_value[0]] = decodeURIComponent(
          key_and_value[1] && key_and_value[1].replace(/\+/g, " ")
        );
      }
      return holder;
    };
    ...
    this.getStorageUrl = function () {
      ...
      return $.when($.get(getActionPath() + "storage_info.txt")).then(function (
        data
      ) {
        storageUrl = {};
...
(function ($, _Logger) {
  ...
  ScriptInvoker = function () {
    ...
    this.addSource = function (src) {
      ...
      if (src.indexOf(".js") < 0)
        throw new IllegalArgumentException(
          "Source must be a file with *.js extension"
        );
      sources.push(src);
      return this;
    };
      ...
      loadScripts(function () {
        ...
        for (var i in commands) {
          ...
          if (typeof f == "function") f.apply(null, args);
            ...
            if (gf) gf.apply(null, args);
            else LOGGER.error("Tried to invoke not existing function " + f);
          }
        }
        if (clean) self.clear();
      });
...
String.prototype.escapeHTML = function () {
  return document
    .createElement("div")
    .appendChild(document.createTextNode(this)).parentNode.innerHTML;
};
...
var Map = function () {
  ...
  this.slice = function (start, end) {
    if (start >= db.length || end >= db.length)
      throw new IllegalArgumentException(
        "Start and end positions should be < that hashMap's size"
      );
    var result = new Map();
...
function Element() {
  ...
  this.addAttribute = function (n, v) {
    if (typeof n !== "string")
      ...
      throw new IllegalArgumentException(
        "Value of attribute should be a string or number"
      );
...
(function ($, _Templatetor, _StepInvoker) {
  Radio = function (n) {
    if (typeof n === "string") this.setName(n);
    var checked = false;
    ...
    this.checked = function (b) {
      if (typeof b !== "boolean")
        throw new IllegalArgumentException(
          "Checked state should be a bool value"
        );
      checked = b;
      return this;
    };
  ...
  Radios = function (n) {
    ...
    this.addRadio = function (label, value, checked) {
      if (typeof value !== "string" && typeof value !== "number")
        throw new IllegalArgumentException(
          "Value should be a number of string"
        );
      else if (!this.getName())
        throw new IllegalStateException(
          "Specify name of the radio-group first!"
        );
      this.setLabel(label);
      this.setValue(value);
      var radio = new Radio(this.getName())
        .setValue(this.getValue())
        .checked(!!checked);
      if (this.getLabel()) radio.setLabel(this.getLabel());
      options.push(radio);
      return this;
    };
    ...
    this.render = function () {
      if (options.length == 0)
        throw new NoArgumentException(
          "Nothing to render. Please add at least one radio."
        );
      var result =
        '<div class="radios form-group" for="' + this.getName() + '">\n';
      for (var i = 0; i < options.length; i++) result += options[i].render();
      result += "</div>\n";
      return result;
    };
  };
  ...
  Select = function (n) {
    ...
    this.render = function () {
      if (!this.getName() || Object.keys(options).length == 0)
        throw new Error(
          "Please check element's name, values and default value"
        );
      var result = '<div class="form-group" for="' + this.getName() + '">\n';
      result += "<select" + this.getParams() + ">\n";
      result +=
        '<option value="-1" selected="selected" disabled="disabled">{{CHOOSE_SELECT}}</option>\n';
      ...
      for (var i = 0; i < options.length; i++)
        result +=
          ...
          options[i][1] +
          '"' +
          (options[i][2] === true ? ' selected="selected"' : "") +
          ">" +
          options[i][0] +
          "</option>\n";
  ...
  TextInput = function (n) {
    ...
    this.maxLength = function (length) {
      if (typeof length !== "number")
        throw new IllegalArgumentException("MaxLength should be an integer");
      maxLength = length;
      return this;
    };
  ...
  TextArea = function (n) {
    ...
    this.render = function () {
      ...
      var result = '<div class="form-group" for="' + this.getName() + '">\n';
      result +=
        "<textarea" + this.getParams() + ' placeholder="' + placeholder + '">';
      if (this.value) {
  ...
  DroppableArea = function (n) {
    ...
    this.render = function () {
      ...
      var result =
        '<div class="form-group droppable-area" for="' +
        this.getName() +
        '">\n';
      ...
      _StepInvoker
        .addSource(
          "/cdn/javascripts/jtrainer/current/js/additions/drag-drops.js"
        )
        .addCommand("makeDroppable", this.getName());
      return result;
    };
  };
  ...
  DraggableGroup = function (n) {
    ...
    this.addOption = function (label, value) {
      if (!label || !value)
        throw new IllegalArgumentException(
          "Please check arguments at DraggableGroup!"
        );
    ...
    this.render = function () {
      if (this.getName().length == 0)
        ...
        throw new Error(
          "Nothing to add into DraggableGroup! Please add some options to DraggableGroup!"
        );
      ...
      _StepInvoker
        ...
        .addCommand("makeDraggable", this.getName());
      return result;
    };
  };
  ...
  WolframAlpha = function () {
    ...
    this.doQuery = function (callback) {
      $.ajax({
        url: "https://dl.sumdu.edu.ua/api/v1/content/alpha",
        data: { input: query },
        dataType: "jsonp",
      })
        .done(function (json) {
  ...
  GoogleCharts = function () {
    ...
    this.setOptions = function (options) {
      if (typeof options !== "object")
        throw new IllegalArgumentException(
          "chartOptions should be an json object!"
        );
  ...
  LateX = function () {
     ...
     */
    this.render = function () {
      if (!formula) throw new NoArgumentException("Set formula first!");
      return (
        '<img class="latex" src="http://latex.codecogs.com/svg.latex?' +
        formula +
        '" border="0"/>'
      );
    };
...
var BreadCrumb = new (function () {
  ...
  this.setBreadCrumbElement = function (o) {
    if (!(o instanceof $))
      throw new IllegalArgumentException(
        "BreadCrumb should be an instance of $"
      );
    breadCrumbElement = o;
    return this;
  };
...
var ProgressBar = new (function () {
  ...
  this.setProgressBarElement = function (o) {
    if (!(o instanceof $))
      throw new IllegalArgumentException(
        "ProgressBar should be an instance of $"
      );
  ...
  this.changeProgressBarState = function (total, next) {
    var fullness;
    if (total != 0) fullness = ((next / total) * 100).toFixed(1) + "%";
    else fullness = "0%";
...
(function (
  ...
  Rotator = new (function () {
    ...
    this.setPrevButton = function (o) {
      if (!(o instanceof $))
        throw new IllegalArgumentException(
          "Controller should be an instance of $"
        );
      prevButton = o;
      return this;
    };
    ...
    this.disablePrevButton = function () {
      if (prevButton) prevButton.addClass("disabled").attr("onclick", "");
      return this;
    };
    ...
    this.setStepSpace = function (ss) {
      if (!(ss instanceof $))
        throw new IllegalArgumentException(
          "Step's space should be an instance of jQuery"
        );
      else if (ss.length == 0)
    ...
    this.getStepsCount = function () {
      if (stepsCount) return stepsCount;
      else throw new IllegalStateException("stepsCount is not initialized");
    };
        ...
        .done(function (script) {
          ...
          if (typeof stepJSObject === "function") {
            ...
            var mergeView = function () {
              ...
              if (typeof mustache === "object") view = mustache;
            };
    ...
    var getStepData = function (step, callback) {
      $.get(STEP_PATH + settings[step]["filename"] + ".html")
        .done(function (data) {
          ...
          data =
            '<div data-step="' + step + '" class="step">' + data + "</div>";
          LOGGER.debug(data);
          callback(data);
        })
        .fail(function (jqxhr, settings, exception) {
    ...
    var loadStep = function (step, callback) {
      if (!settings || settings.length === 0)
        throw new IllegalStateException(
          "Step's settings haven't been loaded yet or is empty"
        );
      ...
      getStepData(step, function (html) {
        ...
        getStepScript(step, function (mustache, scriptInstance) {
          ...
          if (
            scriptInstance &&
            typeof scriptInstance.postDispatch === "function"
          )
            scriptInstance.postDispatch();
          if (PRODUCTION && step >= settings.length) _Service.pushResults();
          if (typeof callback === "function") callback(data, scriptInstance);
        });
      });
    };
    ...
    this.switchStep = function (step) {
      fadeStepIn(step, function () {
        if (visibleStep < lastLoadedStep) self.enableNextButton();
        else self.disableNextButton();

        if (visibleStep > 0) self.enablePrevButton();
        else self.disablePrevButton();
      });
    };
    ...
    this.getStepScore = function (step) {
      ...
      else return settings[visibleStep]["score"];
    };
    ...
    this.getNextStepScore = function (step) {
      if ($.isNumeric(step) && step < settings.length)
        return settings[step]["score"];
      else return settings[visibleStep + 1]["score"];
    };
    ...
    this.getAllStepScores = function () {
      ...
      for (var i = 0; i < totalSteps; i++) scores.push(settings[i].score);
      return scores;
    };
    ...
    this.getAllStepNames = function () {
      var names = [];
      var totalSteps = Object.keys(settings).length;
      for (var i = 0; i < totalSteps; i++) names.push(settings[i].filename);
      return names;
    };
    ...
    this.prevStep = function (callback) {
      ...
      if (prev <= 0) this.disablePrevButton();
    };
...
(function ($, _Logger, _Rotator, _Scorer, _Templatetor) {
  ...
  Validator = function () {
    ...
    this.setIgnoreCase = function (b) {
      if (typeof b !== "boolean")
        throw new IllegalArgumentException(
          "Case sensitivity switch should be boolean"
        );
      ignoreCase = b;
      return this;
    };
    ...
    this.setAttempts = function (a) {
      if (typeof a !== "number" || a <= 0)
        throw new IllegalArgumentException(
          "Amount of attempts should be a number greater then zero"
        );
      attempts = a;
      return this;
    };
    ...
    this.getAttempts = function () {
      if (typeof attempts !== "number")
        throw new IllegalArgumentException(
          "Amount of attempts should be a number"
        );
      return attempts;
    };

    /**
     * Gets a current state of validator state
     * @returns {Validator} current object (flow)
     */
    this.getFulfilled = function () {
      return fulfilled;
    };
    ...
    this.setPenalty = function (p) {
      if (typeof p !== "number" || p <= 0)
        throw new IllegalArgumentException(
          "Penalty size should be a number greater then zero"
        );
      penalty = p;
      return this;
    };
    ...
    this.getPenalty = function () {
      if (typeof penalty !== "number" || penalty <= 0)
        throw new IllegalArgumentException(
          "Penalty should be a number greater then zero"
        );
      return penalty;
    };
    ...
    this.disableAnswersBacklight = function (b) {
      if (typeof b !== "boolean")
        throw new IllegalArgumentException(
          "Disabling answers backlighting trigger should be boolean"
        );
      dab = b;
      return this;
    };
    ...
    this.enableStepFinishAlert = function (b) {
      if (typeof b !== "boolean")
        throw new IllegalArgumentException(
          "Enabling step finish alert trigger should be boolean"
        );
      esfa = b;
      return this;
    };
    ...
    this.addValidator = function (o, v, multicorrect, multiple) {
      ...
      if (!(o instanceof $))
        throw new IllegalArgumentException(
          "Object " + o.val() + " should be an instance of $"
        );
      else if (o.length == 0)
        throw new IllegalArgumentException(
          "DOM Element " + o.selector + " doesn't exist. Validator not added"
        );
    ...
    this.validate = function () {
      ...
      if (isStrict) LOGGER.debug("SCRIPT MODE VALIDATION");
      if (fulfilled === true)
        throw new IllegalStateException(
          "I ended up here. Stop clicking validate!"
        );
      ...
      for (var i = 0; i < targets.length; i++) {
        ...
        if (target.attr("type") === "radio") {
          ...
          currentValue =
            (target.val() ? target.val() : target.attr("value")) + "";
        }
        ...
        if (typeof correctValues === "function") {
          LOGGER.debug(
            "# VALIDATING TARGET WITH FUNCTION <" + target.selector + ">:",
            "Current value:",
            currentValue
          );
          ...
          LOGGER.debug(
            "# VALIDATING TARGET <" + target.selector + ">:",
            "Current value:",
            currentValue,
            "Correct values:",
            correctValues
      ...
      if (checkState === true) {
        ...
        if (attempts <= 0) {
          ...
          var totalElements = targets.length + areasCount;
          var scoreOfOne = stepScore / totalElements;
          var score =
            stepScore - scoreOfOne * (invalidTargets + areasOrder.length);
